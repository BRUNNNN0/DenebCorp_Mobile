...
final class RegisterRepository implements IRegisterRepository {
 ...
 final HttpResponseEntity httpResponse = (await _remoteDataSource.post(_urlRegister,jsonEncode(register.toMap())))!;

    if (httpResponse == null || httpResponse.statusCode != 200) {
      
      final String? error = httpResponse?.data?.toString().toLowerCase();

      debugPrint("teste: $error");
